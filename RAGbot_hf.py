...
RAGbot_hf.py
=============
High-performance RAG chatbot using Hugging Face Transformers 
and a larger model (e.g., Qwen3-8B) for superior legal extraction.
"""
...
def main():
    ...
    model_id = "Qwen/Qwen3-8B" # Adjust to the exact HF path of your 8B model
    ...
    # 3. Hardened System Prompt (The "Strict Legal Assistant" version)
    system_prompt = (
    ...
    print("\nLegal RAG Bot (HF High-Perf) Ready. How can I help you? (enter :q to quit)\n")
